...
import com.example.trainingfragment.fragments.AppFragment.OnListFragmentInteractionListener;
 ...
 * for your data type.
 */
public class MyAppRecyclerViewAdapter extends
        RecyclerView.Adapter<MyAppRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyAppRecyclerViewAdapter(List<DummyItem> items,
