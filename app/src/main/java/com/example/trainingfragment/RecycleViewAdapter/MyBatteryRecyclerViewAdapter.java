...
import com.example.trainingfragment.fragments.BatteryFragment.OnListFragmentInteractionListener;
...
public class MyBatteryRecyclerViewAdapter extends
    ...
    public MyBatteryRecyclerViewAdapter(List<DummyItem> items,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_battery, parent, false);
