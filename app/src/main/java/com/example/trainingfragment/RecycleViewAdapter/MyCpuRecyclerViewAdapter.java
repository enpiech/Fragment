...
import com.example.trainingfragment.fragments.CpuFragment.OnListFragmentInteractionListener;
...
public class MyCpuRecyclerViewAdapter extends
    ...
    public MyCpuRecyclerViewAdapter(List<DummyItem> items,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_cpu, parent, false);
