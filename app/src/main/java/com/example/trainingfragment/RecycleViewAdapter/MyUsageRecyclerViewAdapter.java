...
import com.example.trainingfragment.fragments.UsageFragment.OnListFragmentInteractionListener;
 ...
 * for your data type.
 */
public class MyUsageRecyclerViewAdapter extends
        RecyclerView.Adapter<MyUsageRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyUsageRecyclerViewAdapter(List<DummyItem> items,
